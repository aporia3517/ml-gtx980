...
def load_data(dataset):
    ...
    test_set = (numpy.concatenate( (test_set[0] , numpy.power(test_set[0], 2) , numpy.power(test_set[0], 3)) , axis=1 ) , test_set[1])
    valid_set = (numpy.concatenate( (valid_set[0] , numpy.power(valid_set[0], 2) , numpy.power(valid_set[0], 3)) , axis=1 ) , valid_set[1])
    train_set = (numpy.concatenate( (train_set[0] , numpy.power(train_set[0], 2) , numpy.power(train_set[0], 3)) , axis=1 ) , train_set[1])
