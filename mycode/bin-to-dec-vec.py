...
if __name__ == '__main__':
    for seed in range(106,115):
        test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, dataset='bin-to-dec-interval(0,999)_length-(50000, 10000, 10000)_seed-100.dat', batch_size=10, n_hidden=10, seed=seed)
