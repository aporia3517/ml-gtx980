...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=5000,
             dataset='mnist.pkl.gz', batch_size=20, hidden_layer_sizes=[500,500,500], seed=1234, model='../model/3layermodel-500-500.dat'):
    """
   ...
   """
    model = '../model/3layermodel-500-500-500-seed-' + str(seed) + '.dat'
