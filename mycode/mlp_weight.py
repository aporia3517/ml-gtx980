# weight initialize change with bias, wbias
"""
    ...
    def __init__(self, rng, input, n_in, n_out, W=None, b=None,
        ...
        if W is None:
            W_values = numpy.asarray(
                #rng.uniform(
                #    low=-numpy.sqrt(6. / (n_in + n_out))+wbias,
                #    high=numpy.sqrt(6. / (n_in + n_out))+wbias,
                #    size=(n_in, n_out)
                #),
                rng.normal(
                    loc = 0.,
...
class MLP(object):
    ...
    def __init__(self, rng, input, n_in, n_hidden, n_out, wbias):
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
             dataset='mnist.pkl.gz', batch_size=20, n_hidden=500, seed=1234, wbias=0, model='mlp_wbias.dat'):
    """
...
if __name__ == '__main__':
    test_mlp(n_hidden=500, model='../model/mlp-normal-weight.dat')
