...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, dataset='mnist.pkl.gz', batch_size=20, n_hidden=500, seed=1234):
   ...
   """
    ...
    end_time = time.clock()
    with open('../model/count20.dat', 'wb') as f:
...
if __name__ == '__main__':
    for seed in range(105,115):
        test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, dataset='count-(0,20)_length-(50000, 10000, 10000)_seed-100.dat', batch_size=10, n_hidden=20, seed=seed)
