...
if __name__ == '__main__':
    for i in range(20,40):
        test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=2000, dataset='mnist.pkl.gz', batch_size=20, hidden_layer_sizes=[500,500], seed=i, model='../model/2layer-ReLUmodel-500-500')
