...
class multiMLP(object):
    ...
    def __init__(self, rng, input, n_in, hidden_layer_sizes, n_out):
        ...
        :param hidden_layer_sizes: number of hidden units
...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, dataset='mnist.pkl.gz', batch_size=20, hidden_layer_sizes=[10,10], seed=1234):
    """
   ...
   """
    ...
    end_time = time.clock()
    with open('../model/max3s-5-2.dat', 'wb') as f:
...
if __name__ == '__main__':
    for seed in range(100,120):
		test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, dataset='dim3-interval(0,100)_length-(50000, 10000, 10000)_seed-100.dat', batch_size=20, hidden_layer_sizes=[5,2], seed=seed)
