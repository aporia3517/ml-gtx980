...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, dataset='mnist.pkl.gz', batch_size=20, n_hidden=500, seed=1234, model=''):
    """
   ...
   """
    ...
    print(train_set_x.get_value()[:2])
    print(train_set_y.eval()[:2])
...
if __name__ == '__main__':
    for seed in range(10):
        for nh in range(3,9):
	    test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, dataset='dim3-interval(0,1000)_length-50000_seed-100.dat', batch_size=5, n_hidden=nh, seed=seed, model='../model/max-small-1layer-' + str(nh) + '.dat')
