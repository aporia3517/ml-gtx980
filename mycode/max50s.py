...
if __name__ == '__main__':
	...
	test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=3000, dataset='dim50-interval(0,10000)_length-100000_seed-13.dat', batch_size=20, n_hidden=3000, seed=seed)
