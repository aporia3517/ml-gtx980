...
def load_data(dataset):
    ...
    train_set = (train_set[0] - mean, train_set[1])
    train_set = (train_set[0] / std, train_set[1])
    valid_set = (valid_set[0] - mean, valid_set[1])
    valid_set = (valid_set[0] / std, valid_set[1])
    test_set = (test_set[0] - mean, test_set[1])
    test_set = (test_set[0] / std, test_set[1])

    test_set[0][test_set[0] < 0] = -numpy.power(test_set[0][test_set[0] < 0], 2)
    test_set[0][test_set[0] > 0] = numpy.power(test_set[0][test_set[0] > 0], 2)
    valid_set[0][valid_set[0] < 0] = -numpy.power(valid_set[0][valid_set[0] < 0], 2)
    valid_set[0][valid_set[0] > 0] = numpy.power(valid_set[0][valid_set[0] > 0], 2)
    train_set[0][train_set[0] < 0] = -numpy.power(train_set[0][train_set[0] < 0], 2)
    train_set[0][train_set[0] > 0] = numpy.power(train_set[0][train_set[0] > 0], 2)
