...
def test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, dataset='mnist.pkl.gz', batch_size=20, n_hidden=500, seed=1234):
   ...
   """
    ...
    model_name = '../model/dim4-s-100.dat'
...
if __name__ == '__main__':
    for seed in range(100,120):
        test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, dataset='dim4-interval(0,100)_length-50000_seed-35.dat', batch_size=20, n_hidden=500, seed=seed)
