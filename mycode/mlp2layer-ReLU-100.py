...
if __name__ == '__main__':
    for i in range(13,33):
        test_mlp(learning_rate=0.01, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000, dataset='mnist.pkl.gz', batch_size=20, hidden_layer_sizes=[100,100], seed=i, model='../model/2layer-sqrt1-ReLUmodel-100-100')
